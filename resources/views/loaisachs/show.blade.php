...
@section('title', $main_loaisach->name)
        ...
        <div class="container">
            ...
            @canany(['admin','staff'])
                ...
                <div class="row col-lg-9">
                    <a class="btn btn-primary" href="{{ route('loaisachs.edit', $main_loaisach->id) }}">Edit</a>
                    <form action="{{ route('loaisachs.destroy', $main_loaisach->id) }}" method="post">
                        @csrf
                        @method('DELETE')
                ...
                <div class="shop__sidebar">
                    <aside class="wedget__categories poroduct--cat">
                        ...
                        <ul>
                            ...
                            @foreach($loaisachs as $loaisach)
                                <li>
                                    <a href="{{ route('loaisachs.show', $loaisach->id) }}" @if($main_loaisach->id==$loaisach->id) class="text-primary" @endif>{{ $loaisach->name }}
